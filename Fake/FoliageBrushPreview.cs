...
public class FoliageBrushPreview : SceneCustomObject
{
	public Texture Texture { get; set; }
	public float Radius { get; set; } = 16.0f;
	public Color Color { get; set; } = Color.White;

	public FoliageBrushPreview( SceneWorld world ) : base( world )
	{
	...
	{
		var material = Material.FromShader( "shaders/brushpreviewshader.shader" );
...
// Add all this shit so I can draw a cube and forget to put it somewhere better

file static class VertexBufferExtensions
{
	/// <summary>
